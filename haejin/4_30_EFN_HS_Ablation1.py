...
os.makedirs("weights", exist_ok=True) # added a weights/ directory for the weights to be saved, following line 884
...
for epoch in range(1, Config["epochs"] + 1):
    ...
    log_dict = {
        ...
        # sensitivity at 95% specificity
        "val/sensitivity_mel_95spec": mel_sens_at_95spec,
    }
    ...
    if bacc > best_bacc + Config.get("min_delta", 0.001):
        ...
        torch.save(model.state_dict(), "weights/best_bacc_efficientnet_b0.pt") #added to ensemble study
        logger.info("  saved")
    else:
        no_improve += 1
